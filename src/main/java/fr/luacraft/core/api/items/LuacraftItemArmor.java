...
public class LuacraftItemArmor extends ItemArmor
{
    ...
    public String getArmorTexture(ItemStack stack, Entity entity, int slot, String type)
    {
        if(slot == 0 || slot == 1 || slot == 3)
            return Luacraft.getInstance().getModLoader().getCurrentMod().getModId() + ":textures/armor/" + getArmorMaterial().name() + "_layer_1.png";
        else
            return Luacraft.getInstance().getModLoader().getCurrentMod().getModId() + ":textures/armor/" + getArmorMaterial().name() + "_layer_2.png";
    }
